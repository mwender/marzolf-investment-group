...
function infinity_front_page_widgets_02(){
	...
	genesis_widget_area( 'front-page-6', array(
		...
		'after'  => '</div></div><img src="' . get_stylesheet_directory_uri() . '/images/marzolf-team_1602x1068.jpg' . '" style="width: 680px; height: 453px; margin: 3em 0 0 0; transform: rotate(3deg); border: 7px solid #fff; box-shadow: 3px 3px 3px rgba(0,0,0,0.6);" /></div>',
	) );
